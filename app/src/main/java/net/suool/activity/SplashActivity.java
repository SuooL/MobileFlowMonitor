...
public class SplashActivity extends Activity {
    ...
    private UpdateInfo info;             // XML更新数据实体
    private ProgressDialog pd;           // 等待条
    private RelativeLayout rl_splash;    // 布局
            ...
            switch (msg.what) {
                ...
                case GET_INFO_SUCCESS:
                    ...
                    if (currentversion.equals(serverversion)) {
                        ...
                        Toast.makeText(getApplicationContext(), "暂无新版，无需升级", Toast.LENGTH_SHORT).show();
                        loadMainUI();
                    } else {
        ...
        public void run() {
            ...
            try {
                ...
                if (code == 200) {// 响应码为200时，表示与服务端连接成功
                    ...
                    info = UpdateInfoXML.getUpdateInfo(is);
